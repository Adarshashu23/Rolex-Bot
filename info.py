...
PICS = (environ.get('PICS', 'https://telegra.ph/file/09ce7b61f1efa8c1eb28a-6931f870508eecd237.jpg')).split()
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002422886386') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mrtechmalayalam1:kMKvlEXIvhYC2K5J@cluster0.feas8nb.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
